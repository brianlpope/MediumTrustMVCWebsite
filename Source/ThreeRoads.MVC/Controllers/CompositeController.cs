...
namespace ThreeRoads.MVC.Controllers
{
    public class CompositeController : BaseController
    {
        ...
        {
            ViewBag.Article = _articleRepository.FindByTopic("Staff");
        ...
        {
            ViewBag.Article = _articleRepository.FindByTopic("Board");
        ...
        public ActionResult ERB()
        {
            ...
            IEnumerable<Download> downloads = _downloadRepository.GetPathedList(documentPath).Where(i=>i.Topic=="ERB").OrderBy(e=>e.Title);
        ...
        public ActionResult Downloads()
        {
            ...
            IEnumerable<Download> downloads = _downloadRepository.GetPathedList(documentPath).Where(i => i.Topic == "Download").OrderBy(e => e.Title);
